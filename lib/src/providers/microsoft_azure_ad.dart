...
import 'package:openid_client/openid_client.dart' show OpenIdClaims;

export 'package:openid_client/openid_client.dart'
    show Address, OpenIdClaims, UserInfo;
...
class MicrosoftAuthParams {
  ...
  /// 	recommended	Specifies how the identity platform should return the requested token to your app.
  ///
  /// Supported values:
...
class MicrosoftTenant {
  ...
  /// or 8eaef023-2b34-4da1-9baa-8bc8c9d6a490Only users from a
